...
const updateCuisine = async (req, res) => {
    ...
    try {
        const updatedCuisine = CuisineModel.findByIdAndUpdate(cuisineId, { cuisineName }, { new: true } //returns new modifiend object
        );
        if (updateCuisine) {
            return res.status(Constants.OK).json({
                isSuccess: true,
...
//# sourceMappingURL=CuisineController.js.map