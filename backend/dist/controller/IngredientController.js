...
const updateIngredient = async (req, res) => {
    ...
    try {
        ...
        ;
        const updatedIngredient = await IngredientModel.findByIdAndUpdate(id, { ingredientName }, { new: true } //returns new modifiend object
        );
...
export { addOneIngredient, getAllIngredients, deleteIngredient, updateIngredient };
